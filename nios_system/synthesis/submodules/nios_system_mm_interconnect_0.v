...
module nios_system_mm_interconnect_0 (
	...
	wire   [8:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> switches_s1_agent:cp_channel
	...
	wire   [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> pushbuttons_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_006_src_data;                                                               // cmd_mux_006:src_data -> hex0_s1_agent:cp_data
	wire         cmd_mux_006_src_ready;                                                              // hex0_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire   [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> hex0_s1_agent:cp_channel
	...
	wire  [94:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> timer_0_s1_agent:cp_data
	...
	wire  [94:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> leds_s1_agent:cp_data
	...
	wire  [94:0] hex0_s1_agent_rp_data;                                                              // hex0_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [94:0] timer_0_s1_agent_rp_data;                                                           // timer_0_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [94:0] leds_s1_agent_rp_data;                                                              // leds_s1_agent:rp_data -> router_010:sink_data
